...
module PacificaCookbook
  ...
  class PacificaNotificationsBackend < PacificaBase
    resource_name :pacifica_notifybackend

    property :name, String, name_property: true
    property :run_command, String, default: 'celery -A pacifica.notifications.tasks worker -l info'
